    ...
    <div className="min-h-screen bg-[#080808] text-neutral-300 font-sans selection:bg-white/20 selection:text-white">
      ...
      <section className="relative min-h-screen md:h-[90vh] md:min-h-[700px] flex items-center justify-center pt-32 pb-16">
        <div className="absolute inset-0 z-0">
          <img src={case5_1} className="w-full h-full object-cover" referrerPolicy="no-referrer" />
          ...
          <div className="grid md:grid-cols-2 gap-16">
            ...
            <div className="group cursor-pointer">
              <div className="relative aspect-[4/3] overflow-hidden mb-8">
                ...
                <img src={building1} className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105 opacity-90 group-hover:opacity-100" referrerPolicy="no-referrer" />
              </div>
              <div>
            ...
            <div className="group cursor-pointer md:mt-24">
              <div className="relative aspect-[4/3] overflow-hidden mb-8">
                <img src={building2} className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105 opacity-90 group-hover:opacity-100" referrerPolicy="no-referrer" />
              </div>
              <div>
