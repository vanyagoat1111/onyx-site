    ...
    <div className="min-h-screen bg-onyx-950 text-white font-sans selection:bg-blue-600 selection:text-white w-full overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 px-6 lg:px-12 overflow-hidden min-h-[90vh] flex items-center border-b border-onyx-800">
        <div className="absolute inset-0 z-0">
          ...
          <img src="/case3.1.jpg" alt="Logistics background" className="w-full h-full object-cover object-center opacity-40 grayscale-[20%]" />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
             <div className="relative order-2 lg:order-1 pt-12 lg:pt-0">
               ...
               <div className="relative border-2 border-onyx-700 p-3 bg-onyx-800 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                 <img src="/case3.5.jpg" alt="Fleet" className="w-full h-auto object-cover grayscale-[10%]" />
               </div>
