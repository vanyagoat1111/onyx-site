            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="absolute bottom-12 left-6 md:left-24 max-w-xl">
                  ...
                  <p className="font-sans font-light text-ivory/80 text-lg tracking-wide">{filteredProjects[currentSlide].desc}</p>
                </div>
              </motion.div>
            </AnimatePresence>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="w-full md:w-7/12">
                ...
                <div>
                  <div className="font-sans text-[11px] tracking-[0.2em] uppercase">{reviews[active].name}</div>
                  <div className="font-sans font-light text-[10px] uppercase tracking-widest text-gold mt-2 opacity-60">{reviews[active].role}</div>
                </div>
              </div>
            </motion.div>
          </AnimatePresence>
