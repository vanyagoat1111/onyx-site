      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {reasons.map((r, i) => (
          <div key={i} className="group border border-gold/10 p-10 hover:border-gold/30 transition-colors duration-500 bg-dark/50">
            ...
            <p className="font-sans font-light text-[13px] text-ivory/60 leading-relaxed tracking-wide">
              {r.desc}
            </p>
          </div>
        ))}
    ...
    <Section id="process">
      ...
      <div className="grid md:grid-cols-2 gap-16 relative">
        <div className="hidden md:block">
          <div className="sticky top-32 h-[70vh] border border-gold/20 p-8 flex flex-col bg-dark/50 justify-center">
            <h3 className="font-serif text-3xl mb-12 italic text-ivory text-center">График работ</h3>
            <div className="space-y-8 w-full max-w-md mx-auto">
              <div className="group">
                <div className="flex justify-between text-[11px] uppercase tracking-widest text-ivory/80 mb-3 group-hover:text-gold transition-colors">
                  <span>Проектирование и смета</span>
                  <span className="font-serif italic text-lg">15%</span>
                </div>
                <div className="h-1 w-full bg-darker rounded-full overflow-hidden">
                  <div className="h-full bg-gold/50 group-hover:bg-gold w-[15%] transition-colors duration-500" />
                </div>
              </div>
              <div className="group">
                <div className="flex justify-between text-[11px] uppercase tracking-widest text-ivory/80 mb-3 group-hover:text-gold transition-colors">
                  <span>Черновые работы</span>
                  <span className="font-serif italic text-lg">30%</span>
                </div>
                <div className="h-1 w-full bg-darker rounded-full overflow-hidden">
                  <div className="h-full bg-gold/50 group-hover:bg-gold w-[30%] transition-colors duration-500" />
                </div>
              </div>
              <div className="group">
                <div className="flex justify-between text-[11px] uppercase tracking-widest text-ivory/80 mb-3 group-hover:text-gold transition-colors">
                  <span>Инженерные сети</span>
                  <span className="font-serif italic text-lg">25%</span>
                </div>
                <div className="h-1 w-full bg-darker rounded-full overflow-hidden">
                  <div className="h-full bg-gold/50 group-hover:bg-gold w-[25%] transition-colors duration-500" />
                </div>
              </div>
              <div className="group">
                <div className="flex justify-between text-[11px] uppercase tracking-widest text-ivory/80 mb-3 group-hover:text-gold transition-colors">
            ...
            <div className="mt-16 p-8 border border-gold/10 bg-dark text-center flex flex-col items-center justify-center group hover:border-gold/30 transition-colors duration-500">
              <div className="font-serif text-6xl text-gold mb-3 italic">4-6</div>
              <div className="text-[11px] uppercase tracking-widest text-ivory/60 group-hover:text-ivory transition-colors">
                Месяцев средний срок<br/>реализации проекта
              </div>
            </div>
          </div>
        </div>
