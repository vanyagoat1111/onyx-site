...
export function Cursor() {
  ...
  return (
    <motion.div
      className="fixed top-0 left-0 w-8 h-8 rounded-full border border-gold pointer-events-none z-[9999] mix-blend-difference flex items-center justify-center hidden md:flex"
      animate={{
        x: mousePosition.x - 16,
        y: mousePosition.y - 16,
        scale: isHovering ? 1.5 : 1,
        backgroundColor: isHovering ? 'rgba(201, 168, 104, 1)' : 'rgba(201, 168, 104, 0)',
      }}
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
          <div className="flex flex-col">
            ...
            <span className="text-[10px] tracking-[0.5em] opacity-60 uppercase mt-1 font-sans">Interiors & Renovation</span>
          </div>
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <nav className="flex flex-col gap-8 text-center">
              ...
              <a href="tel:+74950000000" className="mt-8 text-xl font-sans font-light tracking-wider text-gold">
                +7 (495) 000-00-00
              </a>
            </nav>
          </motion.div>
    ...
    <footer className="bg-darker pt-24 pb-12 border-t border-gold/10">
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        <div className="md:col-span-1">
          ...
          <span className="text-[10px] tracking-[0.5em] opacity-60 uppercase font-sans mb-6 block text-ivory">Interiors & Renovation</span>
          <p className="font-sans font-light text-[11px] text-ivory/60 leading-relaxed uppercase tracking-widest">
        ...
        <div>
          ...
          <ul className="space-y-4 font-sans font-light text-[11px] uppercase tracking-widest text-ivory/60">
        ...
        <div>
          ...
          <ul className="space-y-4 font-sans font-light text-[11px] tracking-widest uppercase text-ivory/60">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 pt-8 border-t border-gold/10 flex flex-col md:flex-row justify-between items-center gap-4 text-[9px] uppercase tracking-[0.3em] opacity-50">
        <p className="font-sans font-light text-ivory">
          &copy; {new Date().getFullYear()} Artel Interiors Studio. All Rights Reserved.
        </p>
        <a href="#" className="font-sans font-light text-ivory hover:text-gold transition-colors">
