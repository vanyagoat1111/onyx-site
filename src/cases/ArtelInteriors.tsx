...
const services = [
  { title: 'Дизайнерский ремонт', desc: 'Комплексная реализация проекта с полным авторским надзором.', img: '/photos/u-1600607686527-6fb886090705-900.jpg' },
  { title: 'Капитальный ремонт', desc: 'Демонтаж, новые перегородки, полная замена коммуникаций.', img: '/photos/u-1505691938895-1758d7feb511-900.jpg' },
  { title: 'Косметический ремонт', desc: 'Обновление облика без переноса стен и инженерии.', img: '/photos/u-1600585154340-be6161a56a0c-900.jpg' },
  { title: 'Инженерные системы', desc: 'Электрика, вентиляция, кондиционирование, умный дом.', img: '/photos/u-1558002038-1055907df827-900.jpg' },
  { title: 'Ванные комнаты', desc: 'Работа с натуральным камнем и крупноформатным керамогранитом.', img: '/photos/u-1620626011761-996317b8d101-900.jpg' },
  { title: 'Черновая отделка', desc: 'Геометрия стен и стяжки под чистовые покрытия премиум-класса.', img: '/photos/u-1503387762-592deb58ef4e-900.jpg' },
];
...
const works: Work[] = [
  {
    ...
    img: '/photos/u-1600607687920-4e2a09cf159d-1800.jpg',
  ...
  },
  {
    ...
    img: '/photos/u-1600566753190-17f0baa2a6c3-1800.jpg',
  ...
  },
  {
    ...
    img: '/photos/u-1556912173-3bb406ef7e77-1800.jpg',
  ...
  },
  {
    ...
    img: '/photos/u-1517248135467-4c7edcad34c4-1800.jpg',
  ...
  },
  {
    ...
    img: '/photos/u-1600585154340-be6161a56a0c-1800.jpg',
  ...
  },
  {
    ...
    img: '/photos/u-1512917774080-9991f1c4c750-1800.jpg',
        ...
        <>
          ...
          <section className="relative">
            <div className="relative h-[74vh] min-h-[520px] overflow-hidden">
              <img
                src="/photos/u-1600607687920-4e2a09cf159d-2000.jpg"
          ...
          <section className="px-6 md:px-10 py-20 md:py-28">
            <div className="max-w-[1360px] mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-12 lg:gap-16 items-center">
                ...
                <BeforeAfter
                  before="/photos/u-1503387762-592deb58ef4e-1600.jpg"
                  after="/photos/u-1600607687920-4e2a09cf159d-1600.jpg"
                />
              </div>
            </div>
          </section>
