...
export const SectionTitle = ({ children, subtitle, className = '' }: { children: React.ReactNode, subtitle?: string, className?: string }) => (
 ...
 <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-heading font-black uppercase tracking-tight leading-heading text-white relative inline-block drop-shadow-lg">
 {children}
 </h2>
 </div>
);
