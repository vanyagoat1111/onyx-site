...
export default function Stats() {
  const stats = [
    { value: "> 150", label: "бизнесов подключены к нашей подписке и имеют сайт от ONYX прямо сейчас" },
    { value: "> 12.000", label: "человек посещают разработанные нами сайты ежедневно" },
    { value: "80%", label: "Наше предложение на 80% выгоднее чем у других студий (смотрите математические расчеты выгод ниже)" },
    { value: "> 20", label: "Бизнесы из более чем 20 городов России и стран СНГ имеют сайт от ONYX" },
