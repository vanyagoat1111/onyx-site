...
const faqs = [
  { q: "Почему разработка сайта бесплатная?", a: "Мы используем современные технологии разработки и собственную систему шаблонов, что позволяет запускать качественные сайты без крупных первоначальных затрат. Наша бизнес-модель строится на предоставлении инфраструктуры." },
  { q: "Сколько стоит разработка сайта?", a: "Разработка абсолютно бесплатна. Выбирайте необходимый тариф инфраструктуры, а дизайн и код мы берем на себя." },
  { q: "Нужно ли платить за разработку отдельно?", a: "Нет. Мы зарабатываем на предоставлении хостинга и поддержки для вашего сайта, поэтому разработка самого сайта полностью бесплатна." },
  ...
  { q: "Что произойдёт, если мне понадобится доработка сайта?", a: "Мы можем добавлять новые страницы, разделы, интеграции и функционал по мере развития вашего бизнеса. У вас будет личный мастер, которому вы будете писать свои правки, они выполняются в рамках технической поддержки." },
  { q: "Как присваивается домен, можно ли его выбрать?", a: "Вы придумываете, как хотите чтобы назывался ваш сайт, далее мы помогаем вам зарегистрировать это доменное имя." },
  ...
  { q: "Как происходит оплата?", a: "Доступны удобные способы оплаты за выбранные инфраструктурные решения (домен и хостинг) в соответствии с тарифом." },
  { q: "Как понять какой тариф мне нужен?", a: "Заполните анкету и с вами свяжется наш менеджер, представит вам на согласование предварительный план, исходя из которого будет выбран подходящий пакет услуг." },
  ...
  { q: "Что будет с сайтом при приостановке услуг хостинга?", a: "Сайт автоматически будет скрыт провайдером. При возобновлении услуг инфраструктуры сайт вернется в публичный доступ." }
];
