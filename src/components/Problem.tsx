...
export default function Problem() {
  return (
    <Container id="problem" className="bg-onyx-800/30 border-y border-onyx-800 relative">
      <div className="absolute top-1/2 left-0 w-1/4 h-1/2 bg-[radial-gradient(circle_at_left,_var(--tw-gradient-stops))] from-violet-950/20 via-transparent to-transparent pointer-events-none -translate-y-1/2" />
      <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10">
        <div className="relative">
          ...
          <img src="/case0.1.jpg" alt="Abstract structure" className="absolute inset-0 w-full h-full object-cover grayscale opacity-20 clip-diagonal mix-blend-overlay" referrerPolicy="no-referrer" />
        ...
        <div className="space-y-8">
          ...
          >
            <div className="text-6xl md:text-8xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-violet-500 to-violet-800 tracking-tighter shrink-0 select-none drop-shadow-[0_0_15px_rgba(124,58,237,0.5)]">
              90%
            </div>
            <div>
          ...
          <div className="pl-[120px] md:pl-[160px]">
            <p className="text-neutral-500 font-mono text-sm leading-relaxed border-l border-violet-950 pl-6 bg-violet-950/20 py-4 px-2">
