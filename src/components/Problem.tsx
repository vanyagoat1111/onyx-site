...
export default function Problem() {
  return (
    <Container id="problem" className="bg-onyx-800/30 border-y border-onyx-800">
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-8">
          ...
          >
            <div className="text-6xl md:text-8xl font-bold text-white tracking-tighter shrink-0 select-none">
              90%
            </div>
            <div>
          ...
          <div className="pl-[120px] md:pl-[160px]">
            <p className="text-neutral-500 font-mono text-sm leading-relaxed border-l border-neutral-700 pl-6">
