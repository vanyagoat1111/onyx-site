...
const FurnitureMock = () => (
 <div className="bg-white text-warm-granite min-h-max flex flex-col font-sans">
 ...
 <div className="text-xs uppercase tracking-widest font-mono text-neutral-500 border-l-2 border-ash-stroke pl-3">Новая коллекция 2026</div>
 ...
 <button className="bg-obsidian-canvas text-white px-10 py-5 font-bold uppercase tracking-widest text-sm clip-diagonal hover:bg-neutral-800 transition-colors">Смотреть каталог</button>
 </div>
 ...
 <div className="bg-obsidian-canvas text-white p-12 md:p-24 grid grid-cols-1 md:grid-cols-4 gap-12 mt-auto">
...
const CourseMock = () => (
 ...
 <div className="inline-block bg-white text-warm-granite text-xs px-4 py-2 uppercase tracking-widest font-bold mb-8">Новый поток: 15 Ноября</div>
 ...
 <div className="bg-neutral-100 text-warm-granite px-12 py-5 font-bold uppercase tracking-widest clip-diagonal inline-block hover:bg-white transition-colors cursor-pointer text-sm">Занять место на курсе</div>
 </div>
 </div>
 ...
 <br/>
 <button className="bg-white text-warm-granite px-10 py-4 font-bold uppercase tracking-widest clip-diagonal hover:bg-neutral-300 transition-colors">Оставить заявку</button>
 </div>
 </div>
);
...
const BookingMock = () => (
 ...
 <header className="p-6 md:p-8 flex justify-between items-center uppercase tracking-widest font-bold text-xs border-b border-ash-stroke/10 sticky top-0 bg-[#f0ece9]/90 backdrop-blur z-50">
 ...
 <span className="cursor-pointer px-6 py-3 bg-[#2c2c2c] text-white hover:bg-obsidian-canvas transition-colors">Book Now</span>
 </header>
 <div className="p-4 md:p-8 max-w-[1600px] mx-auto">
 <div className="h-[60vh] md:h-[80vh] border border-ash-stroke/10 flex items-end p-8 md:p-16 relative overflow-hidden bg-[#2c2c2c]">
 ...
 <div className="border-b border-ash-stroke/20 pb-2 text-lg font-medium cursor-pointer hover:border-ash-stroke transition-colors">12.05.2026</div>
 </div>
 <div className="md:col-span-1">
 <div className="text-[10px] uppercase text-neutral-500 font-bold mb-2 tracking-widest">Check out</div>
 <div className="border-b border-ash-stroke/20 pb-2 text-lg font-medium cursor-pointer hover:border-ash-stroke transition-colors">18.05.2026</div>
 </div>
 <div className="md:col-span-1">
 <div className="text-[10px] uppercase text-neutral-500 font-bold mb-2 tracking-widest">Guests</div>
 <div className="border-b border-ash-stroke/20 pb-2 text-lg font-medium cursor-pointer hover:border-ash-stroke transition-colors">2 Adults</div>
 </div>
 <button className="md:col-span-1 bg-[#2c2c2c] text-white py-5 uppercase tracking-widest text-[10px] font-bold w-full hover:bg-obsidian-canvas transition-colors">Search</button>
 </div>
 </div>
...
const SmmMock = () => (
 <div className="bg-[#ebff00] text-warm-granite min-h-max font-sans uppercase font-black tracking-tight pb-24">
 <nav className="p-6 md:p-8 flex justify-between items-center border-b-[6px] border-ash-stroke text-2xl md:text-3xl bg-obsidian-canvas text-[#ebff00] sticky top-0 z-50">
 <span>VIRAL_</span>
 <span className="text-sm font-sans font-bold tracking-widest border border-[#ebff00] px-4 py-2 rounded-full cursor-pointer hover:bg-[#ebff00] hover:text-warm-granite transition-colors">СВЯЗАТЬСЯ</span>
 </nav>
 ...
 <div className="bg-obsidian-canvas aspect-square p-8 flex flex-col justify-between clip-diagonal hover:scale-[1.03] cursor-pointer transition-transform relative overflow-hidden group">
 <img src={case1} alt="Image" className="" />
 ...
 <div className="bg-purple-600 aspect-square p-8 flex flex-col justify-between shadow-[16px_16px_0_black] hover:translate-x-2 hover:translate-y-2 hover:shadow-[0_0_0_black] transition-all cursor-pointer border-[6px] border-ash-stroke relative">
 ...
 <div className="bg-obsidian-canvas aspect-square p-8 flex flex-col justify-between rounded-[60px] hover:rounded-lg transition-all duration-300 cursor-pointer text-[#ebff00] border-[6px] border-ash-stroke">
 ...
 <div className="bg-obsidian-canvas text-white p-12 lg:p-24 border-[12px] border-white outline outline-8 outline-black">
 <h2 className="text-5xl md:text-7xl mb-12">ХВАТИТ ДЕЛАТЬ СКУЧНО.</h2>
 <button className="bg-[#ebff00] text-warm-granite w-full py-8 text-3xl md:text-5xl hover:bg-white hover:shadow-[0_0_50px_rgba(255,255,255,0.8)] transition-all rounded-[100px] border-4 border-transparent hover:border-ash-stroke cursor-pointer">ЗАПУСТИТЬ ТРАФИК</button>
 </div>
 </div>
 </div>
);
...
const TemplateSwitcher = ({ name }: { name: string }) => {
 ...
 default: return <div className="text-center p-8 bg-obsidian-canvas text-white h-full flex flex-col items-center justify-center font-mono"><div className="text-4xl mb-4">404</div>Шаблон не найден</div>;
 }
}
...
export default function EditorSimulator({ templateName, onClose }: { templateName: string, onClose: () => void }) {
 ...
 return (
 <div className="fixed inset-0 z-50 flex items-center justify-center p-2 md:p-4 bg-obsidian-canvas/90 backdrop-blur-md">
 <div className="relative w-full h-full max-w-[1800px] max-h-[98vh] border border-ash-stroke bg-obsidian-canvas flex flex-col shadow-2xl rounded-sm overflow-hidden">
 {/* Toast Notification */}
 {toastMessage && (
 <div className="fixed bottom-8 left-1/2 -translate-x-1/2 bg-white text-warm-granite px-6 py-4 font-bold uppercase tracking-widest text-xs clip-diagonal z-[9999] shadow-2xl animate-in fade-in slide-in-from-bottom-4">
 {toastMessage}
 </div>
 )}

 {/* Window Header */}
 <div className="h-12 border-b border-ash-stroke bg-obsidian-canvas flex items-center justify-between px-4 shrink-0 transition-colors">
 ...
 <div className="w-2.5 h-2.5 rounded-full bg-obsidian-canvas"></div>
 <div className="w-2.5 h-2.5 rounded-full bg-obsidian-canvas"></div>
 <div className="w-2.5 h-2.5 rounded-full bg-obsidian-canvas"></div>
 </div>
 ...
 <button onClick={onClose} className="text-neutral-500 hover:text-white transition-colors bg-obsidian-canvas p-1.5 rounded-full hover:bg-red-500/80 hover:text-white">
 <X size={16} />
 </button>
 </div>
 ...
 {/* Content Area */}
 {isLoading ? (
 <div className="flex-grow flex items-center justify-center industrial-grid relative overflow-hidden bg-obsidian-canvas">
 ...
 <div className="w-16 h-16 border-2 border-dashed border-ash-stroke rounded-full animate-[spin_3s_linear_infinite] border-t-white mx-auto mb-6"></div>
 <h3 className="text-2xl sm:text-3xl font-bold uppercase tracking-widest text-white">Инициализация среды</h3>
 <p className="text-white font-mono text-xs sm:text-sm uppercase tracking-widest bg-obsidian-canvas inline-block px-4 py-2 clip-diagonal">
 {isEditMode ? 'Загрузка редактора' : 'Запуск Live версии'}
 </p>
 </div>
 </div>
 ) : (
 <div className="flex h-full w-full bg-obsidian-canvas overflow-hidden select-none relative transition-all">
 {/* Sidebar Tools - Only show in Edit Mode */}
 {isEditMode && (
 <div className="w-16 sm:w-20 md:w-64 border-r border-ash-stroke bg-obsidian-canvas flex flex-col shrink-0 z-20 shadow-xl animate-in fade-in slide-in-from-left-4">
 <div className="h-12 border-b border-ash-stroke hidden md:flex items-center justify-start px-6 shrink-0">
 ...
 <div className="my-2 border-b border-ash-stroke"></div>
 <EditorButton icon={<Settings size={20} />} label="Настройки" active={activeTool === 'Настройки'} onClick={() => handleToolClick('Настройки')} />
 </div>
 <div className="p-4 border-t border-ash-stroke flex flex-col gap-3">
 <button onClick={onClose} className="w-full bg-obsidian-canvas text-white font-mono uppercase tracking-widest text-[9px] sm:text-[10px] py-4 clip-diagonal hover:bg-obsidian-canvas transition-colors">Закрыть</button>
 <button onClick={() => showToast("Сохранение недоступно в режиме демонстрации шаблонов.")} className="w-full bg-white text-warm-granite font-bold uppercase tracking-widest text-[9px] sm:text-xs py-4 clip-diagonal hover:bg-neutral-300 transition-colors hidden md:block">Сохранить</button>
 </div>
 </div>
 )}
 ...
 {/* Top Toolbar */}
 <div className="h-12 border-b border-ash-stroke flex items-center justify-between px-4 sm:px-6 shrink-0 bg-obsidian-canvas relative z-10 shadow-md">
 <div className="flex gap-2 sm:gap-4 justify-start w-auto">
 <button onClick={() => setDevice('desktop')} className={`px-4 py-1.5 transition-colors rounded-sm flex items-center gap-2 ${device === 'desktop' ? 'bg-obsidian-canvas text-white' : 'text-neutral-500 hover:text-white hover:bg-obsidian-canvas/50'}`}>
 <Monitor size={18} /> <span className="hidden lg:inline text-[10px] font-bold uppercase tracking-widest">Desktop</span>
 </button>
 <button onClick={() => setDevice('mobile')} className={`px-4 py-1.5 transition-colors rounded-sm flex items-center gap-2 ${device === 'mobile' ? 'bg-obsidian-canvas text-white' : 'text-neutral-500 hover:text-white hover:bg-obsidian-canvas/50'}`}>
 ...
 {!isEditMode ? (
 <button onClick={() => setIsEditMode(true)} className="bg-white text-warm-granite px-6 py-1.5 text-[10px] font-bold uppercase tracking-widest clip-diagonal hover:bg-neutral-300 transition-colors shadow-[0_0_15px_rgba(255,255,255,0.3)] animate-pulse hover:animate-none flex items-center gap-2">
 <Layout size={14} /> Кастомизировать
 </button>
 ) : (
 <button onClick={() => setIsEditMode(false)} className="bg-obsidian-canvas text-white px-6 py-1.5 text-[10px] font-bold uppercase tracking-widest clip-diagonal hover:bg-obsidian-canvas transition-colors flex items-center gap-2">
 Предпросмотр
 </button>
 )}
 </div>
 ...
 {/* Canvas Workspace */}
 <div className="flex-grow overflow-auto flex items-start sm:items-center justify-center p-0 pt-12 sm:pt-4 sm:p-8 relative industrial-grid bg-obsidian-canvas scroll-smooth">
...
const EditorButton = ({ icon, label, active = false, onClick }: any) => (
 <button onClick={onClick} className={`flex items-center justify-center md:justify-start gap-3 p-3 md:p-4 transition-colors rounded-sm cursor-pointer ${active ? 'bg-obsidian-canvas text-white border-l-2 border-white' : 'text-neutral-500 hover:text-white hover:bg-obsidian-canvas border-l-2 border-transparent'}`}>
 {icon}
