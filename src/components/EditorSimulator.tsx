...
const FurnitureMock = () => (
  <div className="bg-white text-onyx-950 min-h-max flex flex-col font-sans">
    ...
    <div className="px-6 py-16 md:py-24 grid grid-cols-1 md:grid-cols-2 gap-12 items-center bg-neutral-100">
       ...
       <img src="https://images.unsplash.com/photo-1592078615290-033ee584e267?q=80&w=600&auto=format&fit=crop" alt="Furniture" className="aspect-square object-cover clip-diagonal w-full shadow-2xl"  />
    </div>
         ...
         {[1,2,3,4,5,6].map(i => (
           <div key={i} className="space-y-4 group cursor-pointer">
             <div className="overflow-hidden clip-diagonal relative">
               <img src={`https://images.unsplash.com/photo-1503602642458-232111445657?q=80&w=400&auto=format&fit=crop`} alt="Chair" className="bg-neutral-200 aspect-square object-cover w-full grayscale contrast-125 group-hover:scale-105 transition-transform duration-700"  />
...
const CourseMock = () => (
  <div className="bg-[#050505] text-white min-h-max font-sans pb-16">
     <div className="pt-24 md:pt-32 px-6 md:px-8 pb-16 md:pb-24 text-center relative overflow-hidden border-b border-white/10">
        <img src="https://images.unsplash.com/photo-1580582932707-520aed937b7b?q=80&w=1200&auto=format&fit=crop" alt="Class" className="absolute inset-0 w-full h-full object-cover grayscale mix-blend-overlay opacity-20 pointer-events-none"  />
   ...
   <div className="bg-[#f0ece9] text-[#2c2c2c] min-h-max font-sans pb-24">
     ...
     <div className="p-4 md:p-8 max-w-[1600px] mx-auto">
        <div className="h-[60vh] md:h-[80vh] border border-onyx-950/10 flex items-end p-8 md:p-16 relative overflow-hidden bg-[#2c2c2c]">
           <img src="https://images.unsplash.com/photo-1571896349842-33c89424de2d?q=80&w=1200&auto=format&fit=crop" alt="Resort" className="absolute inset-0 w-full h-full object-cover mix-blend-overlay opacity-60 hover:scale-105 transition-transform duration-[20s]"  />
     ...
     <div className="max-w-7xl mx-auto px-6 md:px-8 mt-24 md:mt-32 grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-32 items-center">
       ...
       <img src="https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?q=80&w=800&auto=format&fit=crop" alt="Villa" className="w-full aspect-[4/5] object-cover shadow-xl"  />
     </div>
  </div>
);
  ...
  <div className="bg-white text-violet-950 min-h-max font-sans flex flex-col box-border border-[12px] border-violet-950/5 p-4 md:p-8">
     ...
     <div className="flex-grow grid grid-cols-1 lg:grid-cols-2 border-2 border-violet-950/10 mb-12">
        <div className="p-12 md:p-24 flex flex-col justify-center lg:border-r-2 border-violet-950/10 relative overflow-hidden">
           <img src="https://images.unsplash.com/photo-1517048676732-d65bc937f952?q=80&w=1200&auto=format&fit=crop" alt="Consulting" className="absolute inset-0 w-full h-full object-cover grayscale opacity-5 mix-blend-multiply pointer-events-none"  />
...
const PsychologistMock = () => (
  <div className="bg-[#FAF9F7] text-[#4A4743] min-h-max font-serif">
     ...
     <div className="max-w-4xl mx-auto py-24 px-6 md:px-8 text-center space-y-12">
        <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=400&auto=format&fit=crop" alt="Portrait" className="w-32 h-32 md:w-48 md:h-48 rounded-full mx-auto shadow-xl object-cover grayscale mb-12"  />
   ...
   <div className="bg-[#ebff00] text-onyx-950 min-h-max font-sans uppercase font-black tracking-tight pb-24">
     ...
     <div className="px-6 md:px-12 grid grid-cols-1 md:grid-cols-3 gap-6 text-white text-3xl mb-20">
        <div className="bg-onyx-950 aspect-square p-8 flex flex-col justify-between clip-diagonal hover:scale-[1.03] cursor-pointer transition-transform relative overflow-hidden group">
           <img src="https://images.unsplash.com/photo-1611162617474-5b21e879e113?q=80&w=600&auto=format&fit=crop" alt="Social" className="absolute inset-0 w-full h-full object-cover opacity-20 grayscale group-hover:grayscale-0 group-hover:opacity-50 transition-all pointer-events-none"  />
