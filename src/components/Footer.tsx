        ...
        <div className="grid md:grid-cols-3 gap-12 md:gap-8 mb-16">
          ...
          <div>
            ...
            <p className="text-[12px] font-body text-fog/70 leading-relaxed max-w-xs mt-4">
              Оплата — по счёту (реквизитам): банковским переводом через мобильный банк, СБП или сервис оплаты по реквизитам на Госуслугах. После оплаты вы получаете официальный чек в приложении «Мой налог» в соответствии с 422-ФЗ.
            </p>
          </div>
