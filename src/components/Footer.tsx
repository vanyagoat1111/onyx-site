          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-8">
            ...
            <div className="flex flex-col gap-4 text-sm md:text-base font-black uppercase tracking-[0.2em] text-blue-500">
              ...
              <a href="mailto:onyxwebcooperation@gmail.com" className="hover:text-white hover:drop-shadow-[0_0_10px_#fff] transition-all flex items-start sm:items-center gap-4 group">
                <span className="w-8 h-[2px] bg-onyx-700 group-hover:bg-blue-600 transition-colors shrink-0 mt-2 sm:mt-0"></span> <span><span className="inline-block">onyxwebcooperation</span><wbr /><span className="inline-block">@gmail.com</span></span>
              </a>
            ...
            <div className="space-y-4 font-mono text-xs tracking-widest text-neutral-600 uppercase">
              ...
              <div className="text-[10px] md:text-xs text-neutral-500 space-y-1">
                ...
                <div className="block">Email: <a href="mailto:onyxwebcooperation@gmail.com" className="hover:text-blue-500 hover:drop-shadow-[0_0_5px_rgba(59,130,246,0.5)] transition-all flex-wrap"><span className="inline-block">onyxwebcooperation</span><wbr /><span className="inline-block">@gmail.com</span></a></div>
