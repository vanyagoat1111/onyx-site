          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-8">
            ...
            <div className="space-y-4 font-mono text-xs tracking-widest text-neutral-600 uppercase">
              ...
              <div className="flex flex-wrap gap-4 md:gap-6 mt-6">
                ...
                <a href="#partner" className="hover:text-blue-300 hover:drop-shadow-[0_0_5px_rgba(147,197,253,0.3)] transition-all text-blue-400 font-bold uppercase">Партнерская программа</a>
              </div>
            </div>
