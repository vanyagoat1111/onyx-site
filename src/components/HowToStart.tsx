  ...
  const steps = [
    {
      ...
      desc: "Заполните форму для бесплатного аудита или напишите нам. Мы свяжемся с вами в течение 10 минут."
    },
    {
      num: "02",
      title: "Анализ и стратегия",
      desc: "Мы изучаем вашу нишу, предлагаем оптимальное решение и показываем, как сайт будет приносить клиентов."
    },
    {
      num: "03",
      title: "Запуск за 1-2 дня",
      desc: "Создаем сайт, настраиваем формы и аналитику. Вы принимаете готовую работу и начинаете получать заявки."
    }
  ];
