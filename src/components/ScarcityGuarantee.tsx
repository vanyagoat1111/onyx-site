    ...
    <Container className="bg-onyx-950 border-b border-onyx-800 relative overflow-hidden">
      ...
      <div className="grid md:grid-cols-2 gap-16 md:gap-32 relative z-10">
        <div className="space-y-8">
          ...
          <h2 className="text-4xl md:text-5xl font-bold uppercase tracking-tighter leading-tight text-white drop-shadow-[0_0_15px_rgba(124,58,237,0.2)]">
            Ограниченная квота
          </h2>
        ...
        <div className="space-y-8 flex flex-col justify-center mt-8 md:mt-0">
          <h3 className="text-violet-600 font-mono text-sm tracking-[0.2em] uppercase border-l-2 border-violet-700 pl-4">Предоставление гарантии</h3>
          <h2 className="text-4xl md:text-5xl font-bold uppercase tracking-tighter leading-tight text-white drop-shadow-[0_0_15px_rgba(124,58,237,0.2)]">
          ...
          <div className="bg-onyx-900/80 p-8 clip-diagonal border border-onyx-700 relative overflow-hidden mt-4 shadow-[0_0_20px_rgba(46,16,101,0.2)]">
            ...
            <div className="relative z-10">
              ...
              <p className="font-mono text-sm font-bold uppercase tracking-widest border-t border-violet-950/50 pt-4 mt-4 text-violet-100">
