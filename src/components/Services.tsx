  ...
  return (
    <Container id="services">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
        {addons.map((a, i) => (
          <div key={i} className="bg-onyx-950 border border-onyx-700 p-8 flex flex-col hover:bg-onyx-900 hover:border-blue-400/50 transition-all group hover:shadow-[0_0_30px_rgba(147,197,253,0.2)] clip-diagonal relative overflow-hidden">
            ...
            <button className="w-full border border-onyx-700 bg-onyx-800 text-white text-[10px] uppercase tracking-[0.2em] py-3 px-4 clip-diagonal group-hover:border-blue-400 group-hover:bg-blue-400/20 group-hover:text-white transition-all font-black group-hover:shadow-[0_0_15px_rgba(147,197,253,0.3)]">
              {a.action}
            </button>
          </div>
        ))}
